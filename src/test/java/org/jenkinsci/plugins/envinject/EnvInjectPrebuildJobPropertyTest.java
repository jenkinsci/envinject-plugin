...
/**
 * Tests for {@link EnvInjectPrebuildJobProperty}
 * @author Oleg Nenashev
 */
public class EnvInjectPrebuildJobPropertyTest {
    ...
    public void shouldInjectBuildVarsFromPropertiesContent() throws Exception {   
        ...
        EnvInjectPrebuildJobProperty<FreeStyleProject> prop = forPropertiesContent(project, "FOO=BAR");
    ...
    public void shouldNotInjectVariablesIfPropertyIsDisabled() throws Exception {   
        ...
        EnvInjectPrebuildJobProperty<FreeStyleProject> prop = new EnvInjectPrebuildJobProperty<FreeStyleProject>();
    ...
    public void shouldKeepBuildVariablesByDefault() throws Exception {   
        ...
        EnvInjectPrebuildJobProperty<FreeStyleProject> prop = forPropertiesContent(project, "PARAM2=Overridden");
    ...
    public void shouldNotOverrideBuildParametersByDefault() throws Exception {
        FreeStyleProject project = jenkinsRule.createFreeStyleProject();
        EnvInjectPrebuildJobProperty<FreeStyleProject> prop = forPropertiesContent(project, "PARAM=Overridden");
    ...
    @Nonnull
    public EnvInjectPrebuildJobProperty<FreeStyleProject>
            forPropertiesContent(@Nonnull FreeStyleProject job, @Nonnull String content) throws IOException {
        final EnvInjectPrebuildJobProperty<FreeStyleProject> prop = new EnvInjectPrebuildJobProperty<FreeStyleProject>();
